...
old_rx_df = pd.read_csv("GA_2018_permits_lf_rx_old.csv")
old_agr_df = pd.read_csv("GA_2018_permits_lf_agr_old.csv")
old_invalid_df = pd.read_csv("GA_2018_permits_lf_invalid_old.csv")

valid_df = valid_df.reindex(columns=old_rx_df.columns)
combined_rx_df = pd.concat([old_rx_df, valid_df], ignore_index=True)
combined_rx_df.to_csv("GA_2018_permits_lf_rx.csv", index=False, header=True)

agri_df = agri_df.reindex(columns=old_agr_df.columns)
combined_agr_df = pd.concat([old_agr_df, agri_df], ignore_index=True)
combined_agr_df.to_csv("GA_2018_permits_lf_agr.csv", index=False, header=True)
...
combined_invalid_df.to_csv("GA_2018_permits_lf_invalid.csv", index=False, header=True)
