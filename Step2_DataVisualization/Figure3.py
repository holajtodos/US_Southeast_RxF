###############################################################################
# spatial_maps_pm2.5.py  (refactored)
...
im = ax.pcolormesh(cmaq_lon, cmaq_lat, mean_fire_pm25_masked, vmin=0, vmax=3.5,
                   cmap=cc.cm.CET_L11, transform=ccrs.PlateCarree(), zorder=2)
...
cbar.set_label('Annual average high Rx fire smoke days', fontsize=7, fontweight='bold')
for l in cbar.ax.xaxis.get_ticklabels():
    l.set_fontsize(7)
...
axarr[-1].tick_params(axis='x', bottom=True, direction='out')
axarr[-1].set_xlabel("Annual average high Rx fire smoke days", fontsize=15, fontweight='bold')
