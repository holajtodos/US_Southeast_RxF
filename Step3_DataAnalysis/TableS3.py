...
years = [2017, 2018, 2019]
for year in years:
    file_path = os.path.join(dir_python_local, 'collocated_mod_obs', f'aq_SE_{year}', f'AQS_Daily_aq_CONUS_{year}_with_smoke_day.csv')
...
all_data = []
for year in years:
    file_path = os.path.join(dir_python_local, 'collocated_mod_obs', f'aq_CONUS_{year}', f'AQS_Daily_aq_CONUS_{year}_with_smoke_day.csv')
